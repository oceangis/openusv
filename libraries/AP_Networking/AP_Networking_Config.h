...
#else
#define AP_NETWORKING_ENABLED (CONFIG_HAL_BOARD == HAL_BOARD_SITL)
#endif
#endif
...
#endif
#define AP_NETWORKING_BACKEND_CHIBIOS (AP_NETWORKING_BACKEND_DEFAULT_ENABLED && (0 /* ChibiOS removed */) && HAL_USE_MAC)
#endif

#if !defined(AP_NETWORKING_BACKEND_PPP)
#define AP_NETWORKING_BACKEND_PPP (AP_NETWORKING_BACKEND_DEFAULT_ENABLED && (0 /* ChibiOS removed */) && !HAL_USE_MAC)
#endif
...
#define AP_NETWORKING_PPP_GATEWAY_ENABLED AP_NETWORKING_BACKEND_PPP
#endif
