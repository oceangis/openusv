...
static const ap_message STREAM_EXTENDED_STATUS_msgs[] = {
    ...
    MSG_MCU_STATUS,
#endif
#if AP_MAVLINK_MSG_MEMINFO_ENABLED
    MSG_MEMINFO,
#endif
#if AP_MAVLINK_MSG_VIBRATION_ENABLED && !APM_BUILD_TYPE(APM_BUILD_AntennaTracker)
...
#if AP_MAVLINK_MSG_LOCAL_POSITION_ENABLED
    MSG_LOCAL_POSITION
#endif  // AP_MAVLINK_MSG_LOCAL_POSITION_ENABLED
};
...
static const ap_message STREAM_EXTRA1_msgs[] = {
    ...
    MSG_SIMSTATE,
#endif
#if AP_MAVLINK_MSG_AHRS2_ENABLED
    MSG_AHRS2,
#endif  // AP_MAVLINK_MSG_AHRS2_ENABLED
#if AP_RPM_ENABLED
    MSG_RPM,
#endif
...
#if AP_MAVLINK_MSG_AHRS_ENABLED
    MSG_AHRS,
#endif  // AP_MAVLINK_MSG_AHRS_ENABLED
...
#if AP_MAVLINK_MSG_DISTANCE_SENSOR_ENABLED
    MSG_DISTANCE_SENSOR,
#endif
#if AP_MAVLINK_MSG_SYSTEM_TIME_ENABLED
    MSG_SYSTEM_TIME,
#endif
...
#endif
#if AP_MAVLINK_MSG_EKF_STATUS_ENABLED
    MSG_EKF_STATUS_REPORT,
#endif  // AP_MAVLINK_MSG_EKF_STATUS_ENABLED
#if AP_MAVLINK_MSG_VIBRATION_ENABLED && !APM_BUILD_TYPE(APM_BUILD_AntennaTracker)
    MSG_VIBRATION,
#endif
};
