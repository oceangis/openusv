...
#define AP_EXTERNAL_AHRS_BNO08X_ENABLED 1
...
#define HAL_EXTERNAL_AHRS_DEFAULT 11
...
#define LORA_PIN_SCK     GPIO_NUM_35
#define LORA_PIN_MISO    GPIO_NUM_36
#define LORA_PIN_MOSI    GPIO_NUM_37
#define LORA_PIN_CS      GPIO_NUM_39
#define LORA_PIN_RST     GPIO_NUM_42
#define LORA_PIN_BUSY    GPIO_NUM_40
#define LORA_PIN_DIO1    GPIO_NUM_41
...
#define HAL_HAVE_SERIAL3_PARAMS 0
...
#define HAL_ESP32_I2C_BUSES \
   { .port=I2C_NUM_0, .sda=GPIO_NUM_9, .scl=GPIO_NUM_10, .speed=400*KHZ, .internal=true, .soft=false }
