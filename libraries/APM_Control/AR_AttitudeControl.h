#pragma once
// Balance bot permanently disabled for ESP32 S3 USV project
...
public:
    ...
    // balancebot functions removed - not applicable for USV
...
private:
    ...
    // balancebot pitch control removed - not applicable for USV
