...
- **UART0**: USB Serial / MAVLink console @ 115200 baud
- **UART1**: GPS (ATGM336H) @ 115200 baud
...
- [ ] Selected SPI pins are not used by ESP32 UARTs
